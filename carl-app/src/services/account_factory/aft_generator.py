...
class AFTGenerator:
    ...
    def generate_complete_aft(
        ...
        files["security-baseline/config-rules.tf"] = self._generate_config_rules(framework)
        files["security-baseline/cloudwatch-alarms.tf"] = self._generate_cloudwatch_alarms(framework)
        files["security-baseline/aws-backup.tf"] = self._generate_aws_backup(framework)
        files["security-baseline/iam-access-analyzer.tf"] = self._generate_access_analyzer(framework)
        ...
        files["logging/vpc-flow-logs-bucket.tf"] = self._generate_vpc_flow_logs_bucket(framework)
...
'''
    ...
    def _generate_config_rules(self, framework: ComplianceFramework) -> str:
        """Generate AWS Config rules for SOC2 compliance."""
        return f'''# AWS Config Rules for {framework.name}
# Generated by CARL
#
# SOC2 Controls: CC6.1, CC7.1, CC7.2, CC8.1

# =============================================================================
# Organization Config Rules (applied to all member accounts)
# =============================================================================
...
resource "aws_config_organization_managed_rule" "guardduty_enabled" {{
...
resource "aws_config_organization_managed_rule" "access_keys_rotated" {{
...
resource "aws_config_organization_managed_rule" "cmk_backing_key_rotation_enabled" {{
...
resource "aws_config_organization_managed_rule" "ec2_imdsv2_check" {{
...
resource "aws_config_organization_managed_rule" "restricted_rdp" {{
...
'''
    ...
    def _generate_cloudwatch_alarms(self, framework: ComplianceFramework) -> str:
        """Generate CloudWatch alarms for SOC2 security monitoring."""
        return f'''# CloudWatch Alarms for {framework.name}
# Generated by CARL
#
# SOC2 Controls: CC7.1, CC7.2 (Security Event Detection & Monitoring)
# CIS Benchmark 3.x (Monitoring)
...
resource "aws_cloudwatch_metric_alarm" "root_usage" {{
  ...
  statistic           = "Sum"
  threshold           = 1
  alarm_description   = "Root account was used - requires immediate review"
...
resource "aws_cloudwatch_metric_alarm" "console_login_no_mfa" {{
  alarm_name          = "soc2-console-login-without-mfa"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = 1
...
resource "aws_cloudwatch_metric_alarm" "iam_policy_changes" {{
  alarm_name          = "soc2-iam-policy-changes"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = 1
...
resource "aws_cloudwatch_metric_alarm" "cloudtrail_changes" {{
  alarm_name          = "soc2-cloudtrail-changes"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = 1
...
resource "aws_cloudwatch_metric_alarm" "security_group_changes" {{
  alarm_name          = "soc2-security-group-changes"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = 1
...
# 8. KMS Key Deletion/Disable (CIS 3.7)
...
resource "aws_cloudwatch_metric_alarm" "kms_changes" {{
  alarm_name          = "soc2-kms-key-changes"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = 1
  ...
  statistic           = "Sum"
  threshold           = 1
  alarm_description   = "KMS key disable or deletion scheduled"
  alarm_actions       = [aws_sns_topic.security_alerts.arn]
  treat_missing_data  = "notBreaching"
}}
...
'''
    ...
    def _generate_aws_backup(self, framework: ComplianceFramework) -> str:
        """Generate AWS Backup configuration for SOC2 compliance."""
        return f'''# AWS Backup for {framework.name}
# Generated by CARL
#
# SOC2 Controls: A1.2 (Recovery), A1.3 (Backup)
...
# =============================================================================
# Backup Plan - Daily (35 day retention)
# =============================================================================

resource "aws_backup_plan" "daily" {{
  name = "soc2-daily-backup"
...
# =============================================================================
# Backup Plan - Monthly (1 year retention)
# =============================================================================

resource "aws_backup_plan" "monthly" {{
  name = "soc2-monthly-backup"
...
# =============================================================================
# Vault Lock (for immutable backups - SOC2 requirement)
# =============================================================================
...
'''
    ...
    def _generate_access_analyzer(self, framework: ComplianceFramework) -> str:
        """Generate IAM Access Analyzer configuration."""
        return f'''# IAM Access Analyzer for {framework.name}
# Generated by CARL
#
...
# =============================================================================
# Archive Rules (auto-archive known acceptable findings)
# =============================================================================

resource "aws_accessanalyzer_archive_rule" "cloudtrail_bucket" {{
  analyzer_name = aws_accessanalyzer_analyzer.organization.analyzer_name
  rule_name     = "cloudtrail-bucket-access"
...
'''
    ...
    def _generate_vpc_flow_logs_bucket(self, framework: ComplianceFramework) -> str:
        """Generate centralized VPC Flow Logs bucket."""
        return f'''# Centralized VPC Flow Logs Bucket for {framework.name}
# Generated by CARL
#
# SOC2 Controls: CC7.2 (Network Monitoring)
