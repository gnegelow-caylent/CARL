...
""",
            ...
            cons=[
                ...
                "Lambda rotation function costs (approx. $1/month per secret)",
            ...
            cost_factors=[
                "Secret storage: $0.40 per secret per month",
                "Rotation Lambda: approx. $1 per secret per month (execution + VPC costs)",
                "API calls: $0.05 per 10,000 calls",
...
""",
            ...
            cost_factors=[
                ...
                "GuardDuty: approx. $4-10/month per account",
...
""",
            ...
            cost_factors=[
                "Secret storage: $0.40 per secret per month",
                "API calls with 5-min caching: ~288 calls/day = approx. $0.13/month per secret",
...
""",
            ...
            cost_factors=[
                ...
                "For 10 secrets with 50 app restarts/month: approx. $0.02/month in API calls",
            ],
...
""",
            ...
            cons=[
                ...
                "EventBridge costs for rotation events (approx. $1/million events)",
                "Application must handle cache invalidation messages",
            ],
            cost_factors=[
                "Secret storage: $0.40 per secret per month",
                "API calls with adaptive caching: approx. $0.05-0.50 per secret per month",
                "EventBridge: approx. $1 per million events (rotation events = minimal)",
