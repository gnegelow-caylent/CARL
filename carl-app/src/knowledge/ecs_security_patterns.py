...
""",
            ...
            cost_factors=[
                ...
                "  - 1 vCPU, 2 GB, 24/7 = approx. $40/month",
...
""",
            ...
            cons=[
                ...
                "GuardDuty ECS costs (approx. $0.012/GB analyzed)",
                "Container Insights costs (approx. $0.30/container/month)",
                "Requires VPC endpoints or NAT Gateway for AWS API calls",
            ],
            cost_factors=[
                "Fargate: $0.04048/vCPU-hour + $0.004445/GB-hour",
                "GuardDuty for ECS: approx. $0.012/GB VPC Flow Logs analyzed",
                "Container Insights: approx. $0.30/container/month",
                "VPC endpoints: $7.20/month per endpoint (Secrets Manager, ECR, CloudWatch)",
                "NAT Gateway: $32.40/month (if not using VPC endpoints)",
                "For 3 tasks: $120 (Fargate) + $1 (GuardDuty) + $1 (Insights) + $21.60 (3 endpoints) = approx. $143/month",
            ],
...
""",
            ...
            cost_factors=[
                "Fargate with Envoy sidecar: approx. $50/task/month (1.25 vCPU, 2.5 GB total)",
                ...
                "For 10 services (30 tasks): $1,500 (Fargate) + $400 (ACM PCA) + $5 (X-Ray) = approx. $1,905/month",
            ],
...
""",
            ...
            cons=[
                "Inspector costs (approx. $0.09 per image scan)",
            ...
            cost_factors=[
                "ECR storage: $0.10/GB-month",
                "Inspector ECR scanning: approx. $0.09 per image re-scan",
                "  - 10 images × 4 scans/month = $3.60/month",
                "EventBridge rules: Free (within limits)",
                "Lambda for automation: approx. $1/month",
                "Security Hub: approx. $1.20/account/month",
                "For 10 images: $0.50 (storage) + $3.60 (Inspector) + $1 (Lambda) + $1.20 (Hub) = approx. $6.30/month",
            ],
...
""",
            ...
            cost_factors=[
                "ECR storage: $0.10/GB-month",
                "Inspector: approx. $0.09 per image scan",
                "Signer: $0.50 per signing operation (50 signs/month = $25)",
                "CodeBuild for remediation: approx. $5/month",
                "Lambda automation: approx. $5/month",
                "S3 for SBOM storage: approx. $1/month",
                "Security Hub: approx. $1.20/account/month",
                "For 10 images: approx. $40/month (includes signing, scanning, automation)",
            ],
...
- Total: approx. $29/month for 4 endpoints
""",
            pros=[
            ...
            cons=[
                "VPC endpoint costs (approx. $29/month for 4 endpoints)",
            ...
            cost_factors=[
                ...
                "For 100 GB/month: $28.80 (endpoints) + $1 (data) = approx. $30/month",
            ],
...
""",
            ...
            cons=[
                ...
                "VPC Flow Logs storage costs (approx. $0.50/GB)",
            ...
            cost_factors=[
                ...
                "GuardDuty: approx. $0.012/GB VPC Flow Logs analyzed",
                "VPC Flow Logs: approx. $0.50/GB + S3 storage",
                "App Mesh: No additional charge",
                "Network Firewall (optional): $284/month per endpoint",
                "For 500 GB/month flow logs: $36 (endpoints) + $400 (PCA) + $6 (GuardDuty) + $250 (flow logs) = approx. $692/month",
            ],
