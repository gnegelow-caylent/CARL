...
""",
            ...
            cost_factors=[
                "EC2 instances: Standard pricing",
                "Systems Manager: $0.00208/hour per managed instance = approx. $1.50/instance/month",
...
""",
            ...
            cost_factors=[
                ...
                "Systems Manager (break glass only): approx. $1/instance/month",
...
""",
            ...
            cost_factors=[
                "EC2 instances: Standard pricing",
                "Systems Manager: approx. $1.50/instance/month",
                "Config rules: $2/rule/region × 5 rules = $10/month",
                "Security Hub: approx. $1.20/account/month",
                "GuardDuty: approx. $4-10/account/month",
                "Inspector: approx. $0.10-1/instance/month (depends on scan frequency)",
                "Application Load Balancer: $16/month",
                "Lambda for remediation: approx. $5/month",
                "For 20 instances: $30 (SSM) + $10 (Config) + $1.20 (Security Hub) + $10 (GuardDuty) + $20 (Inspector) + $16 (ALB) + $5 (Lambda) = approx. $92/month overhead",
            ],
...
""",
            ...
            cost_factors=[
                ...
                "Lambda for automation: approx. $5-10/month",
                "CloudWatch Logs Insights: approx. $0.005/GB scanned",
                "Total: approx. $20-50/month for security group governance",
            ],
...
""",
            ...
            cons=[
                ...
                "Requires Systems Manager costs (approx. $1.50/instance/month)",
            ],
            cost_factors=[
...
""",
            ...
            cost_factors=[
                "Systems Manager: approx. $1.50/instance/month (for Session Manager only)",
                ...
                "  - Weekly builds: approx. $0.60/month",
...
""",
            ...
            cost_factors=[
                "Systems Manager: approx. $1.50/instance/month",
                "Inspector: approx. $0.10-1/instance/month (weekly scans)",
                "Config rules: $2/rule/region × 2 rules = $4/month",
                "Security Hub: approx. $1.20/account/month",
                "AMI storage: approx. $2/month",
                "CI/CD pipeline: approx. $5/month",
                "Lambda for automation: approx. $5/month",
                "For 50 instances: $75 (SSM) + $50 (Inspector) + $4 (Config) + $1.20 (Hub) + $12 (other) = approx. $142/month",
            ],
            monthly_cost_range=(100.00, 500.00),
            implementation_complexity="Very High",
            soc2_controls=[
