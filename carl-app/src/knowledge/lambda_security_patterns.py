...
""",
            ...
            cost_factors=[
                ...
                "For 1M requests/month: $0.20 (requests) + ~$2 (compute) = $2.20/month",
            ],
...
""",
            ...
            cons=[
                ...
                "VPC endpoint costs (~$15-30/month)",
...
""",
            ...
            cons=[
                ...
                "GuardDuty costs (~$0.012/GB)",
            ],
            cost_factors=[
                "Lambda: Standard pricing",
                "Provisioned concurrency: ~$13.50/month",
                ...
                "GuardDuty: ~$5/account/month",
                "Config rules: $2/rule × 3 = $6/month",
                "For 1M requests: $2.20 (requests) + $13.50 (provisioned) + $25 (Signer) + $15 (VPC endpoints) + $14.40 (PrivateLink) + $1.20 (Secrets) + $5 (GuardDuty) + $6 (Config) = ~$82/month",
            ],
...
""",
            ...
            cons=[
                ...
                "VPC endpoint costs (~$7.20/month per service)",
                "Slow cold starts (~10 seconds)",
