...
""",
            pros=[
                "Lowest cost (~$15/month for db.t3.micro)",
                "Simple to set up",
...
""",
            ...
            cost_factors=[
                "RDS instance: db.t3.small Multi-AZ = ~$60/month (2x Single-AZ)",
...
""",
            ...
            cost_factors=[
                "Primary: db.m5.large Multi-AZ = ~$280/month",
                "Read replica: db.m5.large = ~$140/month each",
...
""",
            ...
            cost_factors=[
                "Primary Multi-AZ: db.m5.xlarge = ~$560/month",
                "DR replica Multi-AZ: db.m5.xlarge = ~$560/month",
                "Read replicas: db.m5.large × 2 = ~$280/month",
                "Storage: $0.115/GB-month × 4 instances",
                "Cross-region replication: $0.02/GB (data transfer)",
                "For 1 TB database with 500 GB/month replication: $560 (primary) + $560 (DR) + $280 (replicas) + $460 (storage) + $10 (xfer) = ~$1,870/month",
            ],
    ...
    examples=[
        {
            ...
            "reasoning": "Development data, acceptable downtime. Single-AZ keeps costs low (~$20/month).",
        },
        {
...
""",
            ...
            cons=[
                ...
                "Enhanced Monitoring costs (~$3/month per instance)",
                "Secrets Manager costs ($0.40/secret/month)",
            ],
            cost_factors=[
                "KMS key: $1/month",
                "Enhanced Monitoring: ~$3/month per instance",
                "Secrets Manager: $0.40/secret/month + rotation Lambda (~$1/month)",
...
""",
            ...
            cons=[
                ...
                "Performance Insights retention costs (~$2/month for db.t3.small)",
            ...
            cost_factors=[
                ...
                "Performance Insights (2yr retention): ~$2/month (db.t3.small = 2 vCPU × $0.09)",
                "Audit logs: ~$5-20/month (depends on query volume)",
                "Total: ~$12-27/month overhead",
            ],
...
""",
            ...
            cons=[
                ...
                "Database Activity Streams significant cost (~$0.30/hour = $216/month)",
                "GuardDuty RDS costs (~$0.012/GB analyzed)",
                "Alert fatigue if not properly tuned",
            ],
            cost_factors=[
                "KMS: $1/month + key rotation (free)",
                "Enhanced Monitoring: ~$3/month",
                "Performance Insights (2yr): ~$2/month",
                "Database Activity Streams: ~$216/month per instance",
                "GuardDuty RDS: ~$5-15/month",
                "Config rules: $2/rule × 3 = $6/month",
                "Security Hub: ~$1.20/account/month",
                "VPC Flow Logs: ~$10-50/month",
                "Total: ~$244-294/month overhead per instance",
            ],
    ...
    examples=[
        {
            ...
            "reasoning": "Even for dev, use encryption best practices. Private subnets isolate database. Low overhead cost (~$5/month).",
        },
        {
            "scenario": "Production SaaS application database",
...
""",
            ...
            cost_factors=[
                ...
                "Realistic with lifecycle: ~$100-500/month",
            ],
