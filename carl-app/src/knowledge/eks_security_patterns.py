...
""",
            ...
            cost_factors=[
                ...
                "KMS key: $1/month",
                "SSM Session Manager: ~$1.50/node/month",
...
""",
            ...
            cost_factors=[
                ...
                "GuardDuty for EKS: ~$0.012/GB analyzed",
                ...
                "For 10 nodes: $72 (cluster) + $300 (nodes) + $5 (GuardDuty) + $1.20 (Hub) + $36 (endpoints) = ~$414/month",
            ],
...
""",
            ...
            cost_factors=[
                ...
                "Flow logs storage: ~$0.50/GB + S3",
                "GuardDuty for EKS: ~$0.012/GB",
                "For 20 nodes: ~$50/month (flow logs + GuardDuty)",
            ],
