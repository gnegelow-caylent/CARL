...
""",
            ...
            cost_factors=[
                ...
                "CloudWatch alarms for expiration: ~$0.10/alarm/month",
...
""",
            ...
            cost_factors=[
                ...
                "Third-party certificates: $50-300/cert/year",
                "AWS Config rules: ~$2/rule/region/month",
...
""",
            ...
            cost_factors=[
                ...
                "Lambda function: ~$0.20/month for remediation checks",
                "Route 53: $0.50/zone/month",
                "For 20 certificates: $8 (alarms) + $0.20 (Lambda) + $0.50 (R53) = ~$9/month",
            ],
            monthly_cost_range=(5.00, 50.00),
            implementation_complexity="Medium",
            soc2_controls=[
